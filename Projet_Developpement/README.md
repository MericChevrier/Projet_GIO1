...
<br/>La première à gauche qui est un menu de changement et d'affichage de couche. La deuxième au centre concerne la visualisation des données en 2D et la troisième, à droite, gèrent les aspects liés d'import du projet, les calculs ainsi que la validation des restrictions.
...
#### 3D
***Remarques : Cette partie avec cesium n'est pas terminée. Effectivement, les boutons et calculs ne fonctionnement pas encore tous***
...
2. Partie qui concerne les informations du projet comme le nom, le volume ainsi que la validation du projet par rapport au restrictions. Ces informations sont mises à jour lorsque le bouton de validation est pressé (voir point suivant 3). ***Actuellement ne fonctionne pas encore***
