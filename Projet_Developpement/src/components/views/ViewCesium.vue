    ...
    <div id="menu_gauche">
	  ...
	  <div id="menu_droite">
		  <div id="information_projet">
		  	...
		  	<button class="button is-small" type="button" id="cesium_import_json" v-on:click="CesiumImportJson('geojson/cesium_projet_test.geojson',this.viewer)">Importer .json</button>
